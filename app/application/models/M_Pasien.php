...
class M_Pasien extends CI_Model {
	...
	public function dashboard(){
		...
		return array('banyak_pasien'=>$banyak_pasien,'banyak_pasien_konseling'=>$banyak_pasien_konseling,'datang_bulan_ini'=>$datang_bulan_ini,'verifikasi_bulan_ini'=>$verifikasi_bulan_ini,'pasien'=>$pasien);
	}
	public function semua_atribut(){
		...
		$atribut=array('provinsi'=>$provinsi,'agama'=>$agama,'sumber_biaya'=>$sumber_biaya,'sumber_pasien'=>$sumber_pasien,'narkoba'=>$narkoba);
		return $atribut;
	}
